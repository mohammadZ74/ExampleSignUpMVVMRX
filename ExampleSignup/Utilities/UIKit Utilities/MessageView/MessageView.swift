...
class MessageView: UIView {
    ...
    func showOnView(message: String, theme: Theme,displayTime: TimeInterval = 3) {
        ...
        makeDim()
        hideTimer = Timer.scheduledTimer(timeInterval: displayTime, target: self, selector: #selector(hideView), userInfo: nil, repeats: false)
    }
